Feature: Execute installed git hooks via test goal
  Test goal provides the ability to execute all or specific hooks installed at the moment, to make sure that the
